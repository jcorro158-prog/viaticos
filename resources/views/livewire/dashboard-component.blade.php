                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                        @forelse ($recentCommissions as $commission)
                            <tr class="transition hover:!bg-zinc-100 dark:hover:!bg-zinc-900">
                                <td class="px-6 py-5">
                                ...
                                <td class="px-6 py-5">
                                    @if (!empty($commission->invitation_path))
                                        <a href="{{ asset('storage/' . $commission->invitation_path) }}"
                                           target="_blank"
                                           class="inline-flex items-center rounded-xl border border-sky-200 bg-sky-50 px-3 py-1.5 text-xs font-semibold text-sky-700 transition hover:border-sky-300 hover:bg-sky-100 dark:border-sky-900/40 dark:bg-sky-900/20 dark:text-sky-300 dark:hover:bg-sky-900/30">
                                            Visualizar
                                        </a>
                                    @else
                                ...
                                <td class="px-6 py-5">
                                    @if (!empty($commission->evidence_path))
                                        <a href="{{ asset('storage/' . $commission->evidence_path) }}"
                                           target="_blank"
                                           class="inline-flex items-center rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-100 dark:border-emerald-900/40 dark:bg-emerald-900/20 dark:text-emerald-300 dark:hover:bg-emerald-900/30">
                                            Visualizar
                                        </a>
                                    @else
                                        <span class="inline-flex rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 dark:border-amber-900/40 dark:bg-amber-900/20 dark:text-amber-300">
